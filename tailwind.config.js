...
const generateFontSizes = (values) => {
  ...
  module.exports = {
    ...
    theme: {
        ...
        spacing: generateSpacing([0, 0.25, 0.35, 0.5, 0.55, 0.75, 0.8, 1, 1.1, 1.25, 1.5, 1.67, 2, 2.22, 2.5, 2.77, 3, 3.5, 4, 4.75, 5, 6, 6.25, 7, 7.5, 8, 9, 10, 12, 14, 16, 16.8, 17.5, 18, 20, 22, 24, 26, 28, 30, 32, 40, 48, 55]),
